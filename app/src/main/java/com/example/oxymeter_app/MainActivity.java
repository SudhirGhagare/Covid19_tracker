...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvCases,tvRecovered,tvCritical,tvActive,tvTodayCases,tvTotalDeaths,tvTodaysDeath,tvAffectedCountries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAffectedCountries = findViewById(R.id.tvAffectedCountry);
